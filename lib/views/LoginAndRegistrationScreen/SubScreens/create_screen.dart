                                  ...
                                  child: CustomTextField(
                                    ...
                                    onTap: () async {
                                      ...
                                      DateTime firstAllowedDate = DateTime(
                                          currentDate.year -
                                              100); // Allows up to 100 years back
                                          ...
                                          return Theme(
                                            data: Theme.of(context).copyWith(
                                              colorScheme: ColorScheme.light(
                                                ...
                                                secondary: Colors
                                                    .red, // **Changes the selected date color**
                                              ),
                                              textButtonTheme:
                                                  TextButtonThemeData(
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          borderRadius:
                                              BorderRadius.circular(6),
                                          color: controller.siblings == null ||
                                                  controller.siblings == 10 ||
                                                  (controller.siblings ?? 10) >=
                                                      10
                                              ? Color(0xFFBA7270)
                                              : Color(0xFF86413F),
