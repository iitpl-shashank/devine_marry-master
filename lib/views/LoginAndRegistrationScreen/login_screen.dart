                ...
                children: [
                      ...
                      return Padding(
                        ...
                        child: LoginTextField(
                          ...
                          prefixIcon: CountryCodePicker(
                            onChanged: (country) {
                              Navigator.pop(context, country.dialCode ?? '+91');
                            },
                            initialSelection:
                          ...
                          validator: (value) {
                            ...
                            if (value == null || value.isEmpty) {
                              return StringTexts
                                  .phone_cannot_be_empty; // Updated error message
                            } else if (!ValidatorAndInputFormatters
                                .isValidPhoneNumber(value,
                                    loginController.selectedCountryCode)) {
                              return StringTexts
                                  .Enter_Valid_Phone_Number; // Ensures proper validation
                            }
                            return null;
                          },
                  ...
                  GetBuilder<AuthController>(builder: (controller) {
                    return Padding(
                      ...
                      child: CommonButton(
                        isLightColor: true,
                        text: Get.find<AuthController>().isLoginLoading
                            ? Center(
                        ...
                        onPressed: () {
                          if (Get.find<AuthController>()
                            ...
                            showCustomSnackBar(
                                StringTexts.Enter_Valid_Phone_Number,
                                isError: true);
                          }
                        },
                        isShowIcon: false,
