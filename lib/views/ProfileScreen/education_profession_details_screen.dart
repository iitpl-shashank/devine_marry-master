              ...
              child:
                    ...
                    Flexible(
                      child: CustomDropdownField(
                        ...
                        options: controller.dataModel.qualifications
                            ...
                            .toList(),
                        selectedValue: profileController.highestQualification,
                        onChanged: (value) {
                          profileController
                ...
                Visibility(
                  visible: (controller.degreeResponse.Degrees.isNotEmpty &&
                      profileController.highestQualification != "High School" &&
                      profileController.highestQualification != "Intermediate"),
                  child: Row(
                    children: [
                      Flexible(
                        child: CustomDropdownField(
                      ...
                      child: Padding(
                        ...
                        child: IntrinsicHeight(
                          child: CustomTextField(
                            controller: profileController.startDateController,
                            readOnly: true,
                          ...
                          child: CustomTextField(
                            ...
                            onTap: () async {
                              if (profileController
                                  ...
                                  profileController.selectedStartDate == null) {
                                showCustomSnackBar(
                              ...
                              if (selectedDate != null) {
                                ...
                                profileController.selectedEndDate = selectedDate;
                                String value = DateConverter.formatDate(
                                    selectedDate.toLocal());
                                profileController.endDayController.text = value;
                              }
                              // else {
                ...
                SizedBox(height: 17),
                CustomTextField(
                  controller: profileController.companyOrganisationController,
                      ...
                      Flexible(
                        child: Row(
                          ...
                          children: [
                              ...
                              onTap: () {
                                if (profileController.experience == null ||
                                  ...
                                  profileController.updateExperience(
                                      (profileController.experience ?? 0) - 1);
                                }
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(6),
                                  color: profileController.experience == null ||
                                          profileController.experience == 0 ||
                                          (profileController.experience ?? 0) < 0
                                      ? Color(0xFFBA7270)
                                      : Color(0xFF86413F),
                                ),
                                child: Padding(
                            ...
                            GestureDetector(
                              onTap: () {
                                if ((profileController.experience ?? 0) < 30) {
                                  profileController.updateExperience(
                                      (profileController.experience ?? 0) + 1);
                                }
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(6),
                                  color: profileController.experience == null ||
                                          profileController.experience == 30 ||
                                          (profileController.experience ?? 30) >=
                                              30
                                      ? Color(0xFFBA7270)
                                      : Color(0xFF86413F),
