...
import 'package:devine_marry/widgets/add_photo_widget.dart';
          ...
          child: Column(
            ...
            children: [
                        ...
                        child: Image.network(
                          ...
                          loadingBuilder: (context, child, loadingProgress) {
                            ...
                            return Shimmer.fromColors(
                              baseColor: AppColors.lightTheme,
                              highlightColor: AppColors.lightThemeWith15Opacity,
                              child: Container(
                                height: 115,
                                width: 115,
                      ...
                      child: CustomLinearGradientButton(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                profileController
                                        .profile.value?.data?.user?.connectCount
                                        .toString() ??
                                    "0",
                                style: TextStyle(
                                  fontSize: 24,
                      ...
                      child: CustomLinearGradientButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              profileController
                                      .profile.value?.data?.user?.matchesCount
                                      .toString() ??
                                  "0",
                              style: TextStyle(
                                fontSize: 24,
              ...
              ProfileSectionButton(
                ...
                onTap: () {
                  profileController.profileNavigation('education_profession');
                },
              ),
              ProfileSectionButton(
                title: StringTexts.Personality_Details,
                onTap: () {
                  profileController.profileNavigation('personality_details');
                },
              ),
              ProfileSectionButton(
